...
import fr.toss.FF7Weapons.Aquasaber;
 
 public class Rendercloudcomplete implements IItemRenderer
 {
   private IModelCustom AquasaberModel;
   private ResourceLocation AquasaberTexture;
   
   public Rendercloudcomplete()
   {
/* 23 */     this.AquasaberModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/cloudcompletetsurugi.obj"));
/* 24 */     this.AquasaberTexture = new ResourceLocation("FF7:models/cloudcompletetsurugi.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Aquasaber) {
/* 41 */         Aquasaber i = (Aquasaber)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.AquasaberTexture);
/* 50 */           this.AquasaberModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.AquasaberTexture);
/* 60 */           this.AquasaberModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AquasaberTexture);
/* 71 */       this.AquasaberModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AquasaberTexture);
/* 79 */       this.AquasaberModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AquasaberTexture);
/* 87 */       this.AquasaberModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
