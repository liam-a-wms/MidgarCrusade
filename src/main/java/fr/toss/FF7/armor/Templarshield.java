...
public class Templarshield extends ItemArmor
{
	
	public String textureName;

	public Templarshield(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Templarshield";
		setUnlocalizedName("Templarshield");
