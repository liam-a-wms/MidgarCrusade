...
public class GuiSelectRace extends GuiScreen {
	...
	public void initGui()
	{
		...
		buttons[0] = new GuiButton(42, this.width / 4 - 200, this.height / 4 - 100, 80, 20, ChatColor.RESET + I18n.format("Hume"));
		
		buttons[1] = new GuiButton(43, this.width / 4 - 200, this.height / 4 - 78, 80, 20, ChatColor.RESET + I18n.format("Moogle"));
		
		buttons[2] = new GuiButton(44, this.width / 4 - 200, this.height / 4 - 56, 80, 20, ChatColor.RESET + I18n.format("Viera"));
		
		buttons[3] = new GuiButton(45, this.width / 4 - 200, this.height /  4 - 34, 80, 20, ChatColor.RESET + I18n.format("Bangaa"));
		
		buttons[4] = new GuiButton(46, this.width / 4 - 200, this.height /  4 - 12, 80, 20, ChatColor.RESET + I18n.format("Nu Mou"));

		buttons[5] = new GuiButton(47, this.width / 4 - 200, this.height /  2 - 100, 80, 20, ChatColor.RESET + I18n.format("Seeq"));

		buttons[6] = new GuiButton(48, this.width / 4 - 200, this.height /  2 - 78, 80, 20, ChatColor.RESET + I18n.format("Gria"));
		
		buttons[7] = new GuiButton(49, this.width / 4 - 200, this.height /  2 - 56, 80, 20, ChatColor.RESET + I18n.format("Hurdy"));

		buttons[8] = new GuiButton(50, this.width / 4 - 200, this.height /  2 - 34, 80, 20, ChatColor.RESET + I18n.format("Vaan"));

		buttons[9] = new GuiButton(51, this.width / 4 - 200, this.height /  2 - 12, 80, 20, ChatColor.RESET + I18n.format("Penelo"));
		
		buttons[10] = new GuiButton(52, this.width / 4 - 200, this.height + 0 + 1 - 230, 80, 20, ChatColor.RESET + I18n.format("Adelle"));
		
		buttons[11] = new GuiButton(53, this.width / 4 - 200, this.height + 0 + 1 - 208, 80, 20, ChatColor.RESET + I18n.format("Al-Cid Margrace"));
/*
