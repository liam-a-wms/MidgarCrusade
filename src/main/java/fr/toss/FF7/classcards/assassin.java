...
import fr.toss.client.gui.GuiSelectClassassassin;
import fr.toss.client.gui.GuiSelectHumeClass;

public class assassin extends Item
	{
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
		...
		Minecraft.getMinecraft().displayGuiScreen(new GuiSelectClassassassin());
