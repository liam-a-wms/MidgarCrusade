...
import fr.toss.client.gui.GuiSelectClassberserker;
import fr.toss.client.gui.GuiSelectHumeClass;

public class berserker extends Item
	{
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
		...
		Minecraft.getMinecraft().displayGuiScreen(new GuiSelectClassberserker());
