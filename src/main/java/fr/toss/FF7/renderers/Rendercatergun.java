...
import fr.toss.FF7Weapons.Aiotgun;
 
 public class Rendercatergun implements IItemRenderer
 {
   private IModelCustom AiotgunModel;
   private ResourceLocation AiotgunTexture;
   
   public Rendercatergun()
   {
/* 23 */     this.AiotgunModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/catergun.obj"));
/* 24 */     this.AiotgunTexture = new ResourceLocation("FF7:models/catergun.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Aiotgun) {
/* 41 */         Aiotgun i = (Aiotgun)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.AiotgunTexture);
/* 50 */           this.AiotgunModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.AiotgunTexture);
/* 60 */           this.AiotgunModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AiotgunTexture);
/* 71 */       this.AiotgunModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AiotgunTexture);
/* 79 */       this.AiotgunModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AiotgunTexture);
/* 87 */       this.AiotgunModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
