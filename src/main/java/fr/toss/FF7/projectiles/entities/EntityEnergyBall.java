...
public class EntityEnergyBall extends EntityThrowable{
    ...
    private static final String __OBFID = "CL_00001717";
	   ...
	   public EntityEnergyBall(World p_i1760_1_, double p_i1760_2_, double p_i1760_4_, double p_i1760_6_, double p_i1760_8_, double p_i1760_10_, double p_i1760_12_)
	    {
	        super(p_i1760_1_);
	   ...
	   public EntityEnergyBall(World p_i1761_1_, EntityLivingBase p_i1761_2_, double p_i1761_3_, double p_i1761_5_, double p_i1761_7_)
	    {
	        super(p_i1761_1_);
