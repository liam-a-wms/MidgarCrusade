...
import fr.toss.FF7Weapons.Battlefolio;
 
 public class Renderjacksgun implements IItemRenderer
 {
   private IModelCustom BattlefolioModel;
   private ResourceLocation BattlefolioTexture;
   
   public Renderjacksgun()
   {
/* 23 */     this.BattlefolioModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/jacksgun.obj"));
/* 24 */     this.BattlefolioTexture = new ResourceLocation("FF7:models/jacksgun.png");
   }
