...
import fr.toss.FF7Weapons.Claymore;
 
 public class Rendershuyinsword implements IItemRenderer
 {
   private IModelCustom ClaymoreModel;
   private ResourceLocation ClaymoreTexture;
   
   public Rendershuyinsword()
   {
/* 23 */     this.ClaymoreModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/shuyinsword.obj"));
/* 24 */     this.ClaymoreTexture = new ResourceLocation("FF7:models/shuyinsword.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Claymore) {
/* 41 */         Claymore i = (Claymore)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ClaymoreTexture);
/* 50 */           this.ClaymoreModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ClaymoreTexture);
/* 60 */           this.ClaymoreModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ClaymoreTexture);
/* 71 */       this.ClaymoreModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ClaymoreTexture);
/* 79 */       this.ClaymoreModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ClaymoreTexture);
/* 87 */       this.ClaymoreModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
