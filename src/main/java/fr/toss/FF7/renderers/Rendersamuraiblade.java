...
import fr.toss.FF7Weapons.Chillrod;
 
 public class Rendersamuraiblade implements IItemRenderer
 {
   private IModelCustom ChillrodModel;
   private ResourceLocation ChillrodTexture;
   
   public Rendersamuraiblade()
   {
/* 23 */     this.ChillrodModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/samuraiblade.obj"));
/* 24 */     this.ChillrodTexture = new ResourceLocation("FF7:models/samuraiblade.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Chillrod) {
/* 41 */         Chillrod i = (Chillrod)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ChillrodTexture);
/* 50 */           this.ChillrodModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ChillrodTexture);
/* 60 */           this.ChillrodModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ChillrodTexture);
/* 71 */       this.ChillrodModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ChillrodTexture);
/* 79 */       this.ChillrodModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ChillrodTexture);
/* 87 */       this.ChillrodModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
