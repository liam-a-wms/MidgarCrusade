...
import fr.toss.FF7Weapons.Colichemarde;
 
 public class Renderspikedrod implements IItemRenderer
 {
   private IModelCustom ColichemardeModel;
   private ResourceLocation ColichemardeTexture;
   
   public Renderspikedrod()
   {
/* 23 */     this.ColichemardeModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/spikedrod.obj"));
/* 24 */     this.ColichemardeTexture = new ResourceLocation("FF7:models/spikedrod.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Colichemarde) {
/* 41 */         Colichemarde i = (Colichemarde)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ColichemardeTexture);
/* 50 */           this.ColichemardeModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ColichemardeTexture);
/* 60 */           this.ColichemardeModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ColichemardeTexture);
/* 71 */       this.ColichemardeModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ColichemardeTexture);
/* 79 */       this.ColichemardeModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ColichemardeTexture);
/* 87 */       this.ColichemardeModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
