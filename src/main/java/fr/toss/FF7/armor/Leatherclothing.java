...
public class Leatherclothing extends ItemArmor
{
	
	public String textureName;

	public Leatherclothing(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Leatherclothing";
		setUnlocalizedName("Leatherclothing");
