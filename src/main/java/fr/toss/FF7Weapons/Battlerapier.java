...
public class Battlerapier extends FF7weapon
{
	public boolean idle;
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Battlerapier(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Battle_rapier");
  this.field_150934_a = 20F + p_i45356_1_.getDamageVsEntity();
}
