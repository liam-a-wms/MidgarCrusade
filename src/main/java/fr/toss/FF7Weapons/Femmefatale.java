...
public class Femmefatale extends FF7weapon
{
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Femmefatale(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Femme_fatale");
  this.field_150934_a = 54F + p_i45356_1_.getDamageVsEntity();
}
