...
import fr.toss.FF7Weapons.Ayvuirred;
 
 public class Renderenchantedrod implements IItemRenderer
 {
   private IModelCustom AyvuirredModel;
   private ResourceLocation AyvuirredTexture;
...
/* 40 */       if (item.getItem() == ItemRegistry1.Ayvuirred) {
/* 41 */         Ayvuirred i = (Ayvuirred)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.AyvuirredTexture);
/* 50 */           this.AyvuirredModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.AyvuirredTexture);
/* 60 */           this.AyvuirredModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AyvuirredTexture);
/* 71 */       this.AyvuirredModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AyvuirredTexture);
/* 79 */       this.AyvuirredModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AyvuirredTexture);
/* 87 */       this.AyvuirredModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
