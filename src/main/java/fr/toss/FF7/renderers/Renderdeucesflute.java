...
import fr.toss.FF7Weapons.Atomosblade;
 
 public class Renderdeucesflute implements IItemRenderer
 {
   private IModelCustom AtomosbladeModel;
   private ResourceLocation AtomosbladeTexture;
   
   public Renderdeucesflute()
   {
/* 23 */     this.AtomosbladeModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/deucesflute.obj"));
/* 24 */     this.AtomosbladeTexture = new ResourceLocation("FF7:models/deucesflute.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Atomosblade) {
/* 41 */         Atomosblade i = (Atomosblade)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.AtomosbladeTexture);
/* 50 */           this.AtomosbladeModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.AtomosbladeTexture);
/* 60 */           this.AtomosbladeModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AtomosbladeTexture);
/* 71 */       this.AtomosbladeModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AtomosbladeTexture);
/* 79 */       this.AtomosbladeModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AtomosbladeTexture);
/* 87 */       this.AtomosbladeModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
