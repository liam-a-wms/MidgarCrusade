...
import fr.toss.FF7Weapons.Adamantblade;
 ...
 {
   private IModelCustom cardModel;
   private ResourceLocation cardTexture;
   
   public Rendercard()
   {
/* 23 */     this.cardModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/card.obj"));
/* 24 */     this.cardTexture = new ResourceLocation("FF7:models/card.png");
