...
public class Hempenrobe extends ItemArmor
{
	
	public String textureName;

	public Hempenrobe(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Hempenrobe";
		setUnlocalizedName("Hempenrobe");
