...
public class Minervabustier extends ItemArmor
{
	
	public String textureName;

	public Minervabustier(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Minervabustier";
		setUnlocalizedName("Minervabustier");
