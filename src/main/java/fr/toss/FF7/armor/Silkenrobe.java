...
public class Silkenrobe extends ItemArmor
{
	
	public String textureName;

	public Silkenrobe(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Silkenrobe";
		setUnlocalizedName("Silkenrobe");
