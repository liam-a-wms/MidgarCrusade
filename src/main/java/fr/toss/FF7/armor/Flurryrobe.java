...
public class Flurryrobe extends ItemArmor
{
	
	public String textureName;

	public Flurryrobe(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Flurryrobe";
		setUnlocalizedName("Flurryrobe");
