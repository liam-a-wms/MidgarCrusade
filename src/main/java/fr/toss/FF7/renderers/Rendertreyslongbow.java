...
import fr.toss.FF7Weapons.Defender;
 
 public class Rendertreyslongbow implements IItemRenderer
 {
   private IModelCustom DefenderModel;
   private ResourceLocation DefenderTexture;
   
   public Rendertreyslongbow()
   {
/* 23 */     this.DefenderModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/treyslongbow.obj"));
/* 24 */     this.DefenderTexture = new ResourceLocation("FF7:models/treyslongbow.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Defender) {
/* 41 */         Defender i = (Defender)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.DefenderTexture);
/* 50 */           this.DefenderModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.DefenderTexture);
/* 60 */           this.DefenderModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DefenderTexture);
/* 71 */       this.DefenderModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DefenderTexture);
/* 79 */       this.DefenderModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DefenderTexture);
/* 87 */       this.DefenderModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
