...
import fr.toss.FF7Weapons.Ancientsword;
 
 public class RenderCaladbolg implements IItemRenderer
 {
   private IModelCustom AncientswordModel;
   private ResourceLocation AncientswordTexture;
...
/* 40 */       if (item.getItem() == ItemRegistry1.Ancientsword) {
/* 41 */         Ancientsword i = (Ancientsword)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.AncientswordTexture);
/* 50 */           this.AncientswordModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.AncientswordTexture);
/* 60 */           this.AncientswordModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AncientswordTexture);
/* 71 */       this.AncientswordModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AncientswordTexture);
/* 79 */       this.AncientswordModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AncientswordTexture);
/* 87 */       this.AncientswordModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
