...
public class Firstaid_1 extends Spell {
	...
	{
		return I18n.format("spell.soldier.heal");
	}
	...
	public String[] getDescription() 
	{
		...
		str = new String[1];
		str[0] = "Heal a small amount(+ " + ChatColor.AQUA + (this.player.endurance / 30.0f) + ChatColor.RESET + ") ";
