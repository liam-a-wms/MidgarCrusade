...
public class Entityairrender extends EntityThrowable{
    ...
    private static final String __OBFID = "CL_00001717";
	   ...
	   public Entityairrender(World par2World, EntityPlayer par3EntityPlayer) {
	       super(par2World, par3EntityPlayer);
	   }
	   
	   public Entityairrender(World p_i1760_1_, double p_i1760_2_, double p_i1760_4_, double p_i1760_6_, double p_i1760_8_, double p_i1760_10_, double p_i1760_12_)
	    {
	        super(p_i1760_1_);
	   ...
	   public Entityairrender(World p_i1761_1_, EntityLivingBase p_i1761_2_, double p_i1761_3_, double p_i1761_5_, double p_i1761_7_)
	    {
	        super(p_i1761_1_);
