...
public class Magusrobe extends ItemArmor
{
	
	public String textureName;

	public Magusrobe(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Magusrobe";
		setUnlocalizedName("Magusrobe");
