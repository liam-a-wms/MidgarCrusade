...
public class Survivalvest extends ItemArmor
{
	
	public String textureName;

	public Survivalvest(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Survivalvest";
		setUnlocalizedName("Survivalvest");
