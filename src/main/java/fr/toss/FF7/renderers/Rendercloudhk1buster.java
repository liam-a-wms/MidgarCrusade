...
import fr.toss.FF7Weapons.Arbalest;
 
 public class Rendercloudhk1buster implements IItemRenderer
 {
   private IModelCustom ArbalestModel;
   private ResourceLocation ArbalestTexture;
   
   public Rendercloudhk1buster()
   {
/* 23 */     this.ArbalestModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/cloudhk1buster.obj"));
/* 24 */     this.ArbalestTexture = new ResourceLocation("FF7:models/cloudhk1buster.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Arbalest) {
/* 41 */         Arbalest i = (Arbalest)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ArbalestTexture);
/* 50 */           this.ArbalestModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ArbalestTexture);
/* 60 */           this.ArbalestModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ArbalestTexture);
/* 71 */       this.ArbalestModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ArbalestTexture);
/* 79 */       this.ArbalestModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ArbalestTexture);
/* 87 */       this.ArbalestModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
