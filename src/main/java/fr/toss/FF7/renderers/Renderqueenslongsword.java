...
import fr.toss.FF7Weapons.Catclaws;
 
 public class Renderqueenslongsword implements IItemRenderer
 {
   private IModelCustom CatclawsModel;
   private ResourceLocation CatclawsTexture;
   
   public Renderqueenslongsword()
   {
/* 23 */     this.CatclawsModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/queenslongsword.obj"));
/* 24 */     this.CatclawsTexture = new ResourceLocation("FF7:models/queenslongsword.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Catclaws) {
/* 41 */         Catclaws i = (Catclaws)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.CatclawsTexture);
/* 50 */           this.CatclawsModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.CatclawsTexture);
/* 60 */           this.CatclawsModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CatclawsTexture);
/* 71 */       this.CatclawsModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CatclawsTexture);
/* 79 */       this.CatclawsModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CatclawsTexture);
/* 87 */       this.CatclawsModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
