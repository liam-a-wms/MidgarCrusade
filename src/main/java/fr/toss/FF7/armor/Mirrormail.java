...
public class Mirrormail extends ItemArmor
{
	
	public String textureName;

	public Mirrormail(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Mirrormail";
		setUnlocalizedName("Mirrormail");
