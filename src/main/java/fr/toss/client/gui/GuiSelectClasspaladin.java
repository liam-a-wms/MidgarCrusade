...
public class GuiSelectClasspaladin extends GuiScreen {
	...
	public void initGui()
	{
		...
		buttons[0] = new GuiButton(51, this.width / 2 - 50, this.height + 0 + 1 - 144, 80, 20, ChatColor.RESET + I18n.format("More info"));
    ...
    public void drawScreen(int x, int y, float dunno)
    {
    	...
    	this.drawCenteredString(this.fontRendererObj, I18n.format("Paladin"), this.width / 2, 14, Integer.MAX_VALUE / 2);
