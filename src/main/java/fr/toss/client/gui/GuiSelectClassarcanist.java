...
public class GuiSelectClassarcanist extends GuiScreen {
	
	public static final ResourceLocation CLASSES = new ResourceLocation("magiccrusade:textures/gui/soldiergui.png");
	...
	public void initGui()
	{
		...
		buttons[0] = new GuiButton(86, this.width / 2 - 50, this.height + 0 + 1 - 144, 80, 20, ChatColor.RESET + I18n.format("More info"));
    ...
    public void drawScreen(int x, int y, float dunno)
    {
    	...
    	this.drawCenteredString(this.fontRendererObj, I18n.format("Arcanist"), this.width / 2, 14, Integer.MAX_VALUE / 2);
