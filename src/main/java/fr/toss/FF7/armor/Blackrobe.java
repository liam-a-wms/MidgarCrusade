...
public class Blackrobe extends ItemArmor
{
	
	public String textureName;

	public Blackrobe(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Blackrobe";
		setUnlocalizedName("Blackrobe");
