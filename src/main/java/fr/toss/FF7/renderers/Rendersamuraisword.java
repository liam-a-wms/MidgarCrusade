...
import fr.toss.FF7Weapons.Chirijiraden;
 
 public class Rendersamuraisword implements IItemRenderer
 {
   private IModelCustom ChirijiradenModel;
   private ResourceLocation ChirijiradenTexture;
   
   public Rendersamuraisword()
   {
/* 23 */     this.ChirijiradenModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/samuraisword.obj"));
/* 24 */     this.ChirijiradenTexture = new ResourceLocation("FF7:models/samuraisword.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Chirijiraden) {
/* 41 */         Chirijiraden i = (Chirijiraden)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ChirijiradenTexture);
/* 50 */           this.ChirijiradenModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ChirijiradenTexture);
/* 60 */           this.ChirijiradenModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ChirijiradenTexture);
/* 71 */       this.ChirijiradenModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ChirijiradenTexture);
/* 79 */       this.ChirijiradenModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ChirijiradenTexture);
/* 87 */       this.ChirijiradenModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
