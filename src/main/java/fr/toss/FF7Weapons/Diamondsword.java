...
public class Diamondsword extends FF7weapon
{
	public boolean idle;
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Diamondsword(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Diamond_sword");
  this.field_150934_a = 38F + p_i45356_1_.getDamageVsEntity();
}
