...
public class Whiterobe extends ItemArmor
{
	
	public String textureName;

	public Whiterobe(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Whiterobe";
		setUnlocalizedName("Whiterobe");
