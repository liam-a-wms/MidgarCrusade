...
public class Staffofblessings extends FF7weapon
{
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Staffofblessings(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Staff_of_blessings");
  this.field_150934_a = 27F + p_i45356_1_.getDamageVsEntity();
}
