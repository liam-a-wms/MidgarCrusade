...
public class Genjiarmor extends ItemArmor
{
	
	public String textureName;

	public Genjiarmor(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Genjiarmor";
		setUnlocalizedName("Genjiarmor");
