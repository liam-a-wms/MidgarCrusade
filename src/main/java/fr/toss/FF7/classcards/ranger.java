...
import fr.toss.client.gui.GuiSelectClassranger;

public class ranger extends Item
	{
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
		...
		Minecraft.getMinecraft().displayGuiScreen(new GuiSelectClassranger());
