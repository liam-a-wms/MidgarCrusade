...
public class Boneplate extends ItemArmor
{
	
	public String textureName;

	public Boneplate(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Boneplate";
		setUnlocalizedName("Boneplate");
