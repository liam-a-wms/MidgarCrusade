...
public class Genjishield extends ItemArmor
{
	
	public String textureName;

	public Genjishield(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Genjishield";
		setUnlocalizedName("Genjishield");
