...
import fr.toss.FF7Weapons.Apocalypse;
 
 public class Rendercinquesmace implements IItemRenderer
 {
   private IModelCustom ApocalypseModel;
   private ResourceLocation ApocalypseTexture;
...
/* 40 */       if (item.getItem() == ItemRegistry1.Apocalypse) {
/* 41 */         Apocalypse i = (Apocalypse)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ApocalypseTexture);
/* 50 */           this.ApocalypseModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ApocalypseTexture);
/* 60 */           this.ApocalypseModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ApocalypseTexture);
/* 71 */       this.ApocalypseModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ApocalypseTexture);
/* 79 */       this.ApocalypseModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ApocalypseTexture);
/* 87 */       this.ApocalypseModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
