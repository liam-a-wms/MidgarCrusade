...
public class Crownscepter extends FF7weapon
{
	public boolean idle;
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Crownscepter(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Crown_scepter");
  this.field_150934_a = 35F + p_i45356_1_.getDamageVsEntity();
}
