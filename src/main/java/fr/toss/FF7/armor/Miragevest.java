...
public class Miragevest extends ItemArmor
{
	
	public String textureName;

	public Miragevest(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Miragevest";
		setUnlocalizedName("Miragevest");
