...
public class Carabineermail extends ItemArmor
{
	
	public String textureName;

	public Carabineermail(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Carabineermail";
		setUnlocalizedName("Carabineermail");
