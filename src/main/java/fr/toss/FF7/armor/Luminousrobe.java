...
public class Luminousrobe extends ItemArmor
{
	
	public String textureName;

	public Luminousrobe(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Luminousrobe";
		setUnlocalizedName("Luminousrobe");
