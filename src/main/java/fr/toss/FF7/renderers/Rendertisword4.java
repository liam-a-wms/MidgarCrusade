...
import fr.toss.FF7Weapons.Dagriohm;
 
 public class Rendertisword4 implements IItemRenderer
 {
   private IModelCustom DagriohmModel;
   private ResourceLocation DagriohmTexture;
   
   public Rendertisword4()
   {
/* 23 */     this.DagriohmModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/Tisword4.obj"));
/* 24 */     this.DagriohmTexture = new ResourceLocation("FF7:models/Tisword4.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Dagriohm) {
/* 41 */         Dagriohm i = (Dagriohm)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.DagriohmTexture);
/* 50 */           this.DagriohmModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.DagriohmTexture);
/* 60 */           this.DagriohmModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DagriohmTexture);
/* 71 */       this.DagriohmModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DagriohmTexture);
/* 79 */       this.DagriohmModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DagriohmTexture);
/* 87 */       this.DagriohmModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
