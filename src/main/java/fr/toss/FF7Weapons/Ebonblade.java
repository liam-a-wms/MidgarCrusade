...
public class Ebonblade extends FF7weapon
{
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Ebonblade(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Ebon_blade");
  this.field_150934_a = 50F + p_i45356_1_.getDamageVsEntity();
}
