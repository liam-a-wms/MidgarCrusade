...
import fr.toss.FF7Weapons.Dagger;
 
 public class Rendertisword3 implements IItemRenderer
 {
   private IModelCustom DaggerModel;
   private ResourceLocation DaggerTexture;
...
/* 40 */       if (item.getItem() == ItemRegistry1.Dagger) {
/* 41 */         Dagger i = (Dagger)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.DaggerTexture);
/* 50 */           this.DaggerModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.DaggerTexture);
/* 60 */           this.DaggerModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DaggerTexture);
/* 71 */       this.DaggerModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DaggerTexture);
/* 79 */       this.DaggerModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DaggerTexture);
/* 87 */       this.DaggerModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
