...
public class Galmiashoes extends ItemArmor
{
	
	public String textureName;

	public Galmiashoes(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Galmiashoes";
		setUnlocalizedName("Galmiashoes");
