package fr.toss.common.player.spells.ranger;
...
public class Lifebond_1 extends Spell {
	...
	{
		return I18n.format("spell.ranger.lifebond");
	}
	...
	public String[] getDescription() 
	{
		...
		str = new String[3];
		str[0] = "Heal a target for 4 (+ " + ChatColor.AQUA + (this.player.clarity / 20.0f) + ChatColor.RESET + ") of your";
		str[1] = "health and take";
		str[2] = "4 damages ";
