...
import fr.toss.FF7Weapons.Blueleafflute;
 
 public class Rendernineslance implements IItemRenderer
 {
   private IModelCustom BlueleaffluteModel;
   private ResourceLocation BlueleaffluteTexture;
   
   public Rendernineslance()
   {
/* 23 */     this.BlueleaffluteModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/nineslance.obj"));
/* 24 */     this.BlueleaffluteTexture = new ResourceLocation("FF7:models/nineslance.png");
   }
