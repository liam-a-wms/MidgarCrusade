...
import fr.toss.FF7Weapons.Cypresspole;
 
 public class Rendertisword2 implements IItemRenderer
 {
   private IModelCustom CypresspoleModel;
   private ResourceLocation CypresspoleTexture;
...
/* 40 */       if (item.getItem() == ItemRegistry1.Cypresspole) {
/* 41 */         Cypresspole i = (Cypresspole)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.CypresspoleTexture);
/* 50 */           this.CypresspoleModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.CypresspoleTexture);
/* 60 */           this.CypresspoleModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CypresspoleTexture);
/* 71 */       this.CypresspoleModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CypresspoleTexture);
/* 79 */       this.CypresspoleModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CypresspoleTexture);
/* 87 */       this.CypresspoleModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
