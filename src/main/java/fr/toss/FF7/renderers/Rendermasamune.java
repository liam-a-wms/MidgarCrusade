...
import fr.toss.FF7Weapons.Bloodsword;
 
 public class Rendermasamune implements IItemRenderer
 {
   private IModelCustom BloodswordModel;
   private ResourceLocation BloodswordTexture;
   
   public Rendermasamune()
   {
/* 23 */     this.BloodswordModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/masamune.obj"));
/* 24 */     this.BloodswordTexture = new ResourceLocation("FF7:models/masamune.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Bloodsword) {
/* 41 */         Bloodsword i = (Bloodsword)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BloodswordTexture);
/* 50 */           this.BloodswordModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BloodswordTexture);
/* 60 */           this.BloodswordModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BloodswordTexture);
/* 71 */       this.BloodswordModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BloodswordTexture);
/* 79 */       this.BloodswordModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BloodswordTexture);
/* 87 */       this.BloodswordModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
