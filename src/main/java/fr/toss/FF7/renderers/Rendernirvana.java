...
import fr.toss.FF7Weapons.Bluesaber;
 
 public class Rendernirvana implements IItemRenderer
 {
   private IModelCustom BluesaberModel;
   private ResourceLocation BluesaberTexture;
   
   public Rendernirvana()
   {
/* 23 */     this.BluesaberModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/nirvana.obj"));
/* 24 */     this.BluesaberTexture = new ResourceLocation("FF7:models/nirvana.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Bluesaber) {
/* 41 */         Bluesaber i = (Bluesaber)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BluesaberTexture);
/* 50 */           this.BluesaberModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BluesaberTexture);
/* 60 */           this.BluesaberModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BluesaberTexture);
/* 71 */       this.BluesaberModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BluesaberTexture);
/* 79 */       this.BluesaberModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BluesaberTexture);
/* 87 */       this.BluesaberModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
