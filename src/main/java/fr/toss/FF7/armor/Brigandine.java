...
public class Brigandine extends ItemArmor
{
	
	public String textureName;

	public Brigandine(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Brigandine";
		setUnlocalizedName("Brigandine");
