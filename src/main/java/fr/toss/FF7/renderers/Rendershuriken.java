...
import fr.toss.FF7Weapons.Cinquedea;
 
 public class Rendershuriken implements IItemRenderer
 {
   private IModelCustom CinquedeaModel;
   private ResourceLocation CinquedeaTexture;
   
   public Rendershuriken()
   {
/* 23 */     this.CinquedeaModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/shuriken.obj"));
/* 24 */     this.CinquedeaTexture = new ResourceLocation("FF7:models/shuriken.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Cinquedea) {
/* 41 */         Cinquedea i = (Cinquedea)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.CinquedeaTexture);
/* 50 */           this.CinquedeaModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.CinquedeaTexture);
/* 60 */           this.CinquedeaModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CinquedeaTexture);
/* 71 */       this.CinquedeaModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CinquedeaTexture);
/* 79 */       this.CinquedeaModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CinquedeaTexture);
/* 87 */       this.CinquedeaModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
