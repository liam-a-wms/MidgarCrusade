...
public class Powersash extends ItemArmor
{
	
	public String textureName;

	public Powersash(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Powersash";
		setUnlocalizedName("Powersash");
