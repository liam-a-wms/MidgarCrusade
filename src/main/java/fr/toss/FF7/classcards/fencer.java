...
import fr.toss.client.gui.GuiSelectClassfencer;
import fr.toss.client.gui.GuiSelectHumeClass;

public class fencer extends Item
	{
	public fencer(int id)
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
		...
		Minecraft.getMinecraft().displayGuiScreen(new GuiSelectClassfencer());
