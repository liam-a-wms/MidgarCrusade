...
import fr.toss.FF7Weapons.Crescentbow;
 
 public class Rendersword2 implements IItemRenderer
 {
   private IModelCustom CrescentbowModel;
   private ResourceLocation CrescentbowTexture;
   
   public Rendersword2()
   {
/* 23 */     this.CrescentbowModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/sword2.obj"));
/* 24 */     this.CrescentbowTexture = new ResourceLocation("FF7:models/sword2.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Crescentbow) {
/* 41 */         Crescentbow i = (Crescentbow)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.CrescentbowTexture);
/* 50 */           this.CrescentbowModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.CrescentbowTexture);
/* 60 */           this.CrescentbowModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CrescentbowTexture);
/* 71 */       this.CrescentbowModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CrescentbowTexture);
/* 79 */       this.CrescentbowModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CrescentbowTexture);
/* 87 */       this.CrescentbowModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
