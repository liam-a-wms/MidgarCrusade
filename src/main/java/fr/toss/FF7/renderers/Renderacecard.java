...
import fr.toss.FF7Weapons.Aceofspades;
 
 public class Renderacecard implements IItemRenderer
 {
   private IModelCustom AceofspadesModel;
   private ResourceLocation AceofspadesTexture;
   
   public Renderacecard()
   {
/* 23 */     this.AceofspadesModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/Acecard.obj"));
/* 24 */     this.AceofspadesTexture = new ResourceLocation("FF7:models/Acecard.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Aceofspades) {
/* 41 */         Aceofspades i = (Aceofspades)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.AceofspadesTexture);
/* 50 */           this.AceofspadesModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.AceofspadesTexture);
/* 60 */           this.AceofspadesModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AceofspadesTexture);
/* 71 */       this.AceofspadesModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AceofspadesTexture);
/* 79 */       this.AceofspadesModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AceofspadesTexture);
/* 87 */       this.AceofspadesModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
