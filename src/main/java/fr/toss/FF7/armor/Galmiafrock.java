...
public class Galmiafrock extends ItemArmor
{
	
	public String textureName;

	public Galmiafrock(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Galmiafrock";
		setUnlocalizedName("Galmiafrock");
