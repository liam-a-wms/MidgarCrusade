...
import fr.toss.FF7Weapons.Airblade;
 
 public class Rendermachinarapier implements IItemRenderer
 {
   private IModelCustom AirbladeModel;
   private ResourceLocation AirbladeTexture;
   
   public Rendermachinarapier()
   {
/* 23 */     this.AirbladeModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/machinarapier.obj"));
/* 24 */     this.AirbladeTexture = new ResourceLocation("FF7:models/machinarapier.png");
   }
