...
public class Samitecoat extends ItemArmor
{
	
	public String textureName;

	public Samitecoat(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Samitecoat";
		setUnlocalizedName("Samitecoat");
