...
public class Maximillian extends ItemArmor
{
	
	public String textureName;

	public Maximillian(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Maximillian";
		setUnlocalizedName("Maximillian");
