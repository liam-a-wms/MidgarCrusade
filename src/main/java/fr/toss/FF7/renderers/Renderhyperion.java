...
import fr.toss.FF7Weapons.Battlebamboo;
 
 public class Renderhyperion implements IItemRenderer
 {
   private IModelCustom BattlebambooModel;
   private ResourceLocation BattlebambooTexture;
   
   public Renderhyperion()
   {
/* 23 */     this.BattlebambooModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/hyperion.obj"));
/* 24 */     this.BattlebambooTexture = new ResourceLocation("FF7:models/hyperion.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Battlebamboo) {
/* 41 */         Battlebamboo i = (Battlebamboo)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BattlebambooTexture);
/* 50 */           this.BattlebambooModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BattlebambooTexture);
/* 60 */           this.BattlebambooModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BattlebambooTexture);
/* 71 */       this.BattlebambooModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BattlebambooTexture);
/* 79 */       this.BattlebambooModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BattlebambooTexture);
/* 87 */       this.BattlebambooModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
