...
public class Scorpiontail extends FF7weapon
{
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Scorpiontail(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Scorpion_tail");
  this.field_150934_a = 48F + p_i45356_1_.getDamageVsEntity();
}
