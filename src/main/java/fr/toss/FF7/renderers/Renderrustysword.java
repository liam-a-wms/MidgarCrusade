...
import fr.toss.FF7Weapons.Cheerstaff;
 
 public class Renderrustysword implements IItemRenderer
 {
   private IModelCustom CheerstaffModel;
   private ResourceLocation CheerstaffTexture;
   
   public Renderrustysword()
   {
/* 23 */     this.CheerstaffModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/rustysword.obj"));
/* 24 */     this.CheerstaffTexture = new ResourceLocation("FF7:models/rustysword.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Cheerstaff) {
/* 41 */         Cheerstaff i = (Cheerstaff)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.CheerstaffTexture);
/* 50 */           this.CheerstaffModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.CheerstaffTexture);
/* 60 */           this.CheerstaffModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CheerstaffTexture);
/* 71 */       this.CheerstaffModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CheerstaffTexture);
/* 79 */       this.CheerstaffModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CheerstaffTexture);
/* 87 */       this.CheerstaffModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
