...
public class Jujitsugi extends ItemArmor
{
	
	public String textureName;

	public Jujitsugi(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Jujitsugi";
		setUnlocalizedName("Jujitsugi");
