...
import fr.toss.FF7Weapons.Barong;
 
 public class Rendergunblade implements IItemRenderer
 {
   private IModelCustom BarongModel;
   private ResourceLocation BarongTexture;
   
   public Rendergunblade()
   {
/* 23 */     this.BarongModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/gunblade.obj"));
/* 24 */     this.BarongTexture = new ResourceLocation("FF7:models/gunblade.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Barong) {
/* 41 */         Barong i = (Barong)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BarongTexture);
/* 50 */           this.BarongModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BarongTexture);
/* 60 */           this.BarongModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BarongTexture);
/* 71 */       this.BarongModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BarongTexture);
/* 79 */       this.BarongModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BarongTexture);
/* 87 */       this.BarongModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
