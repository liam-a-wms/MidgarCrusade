...
import fr.toss.client.gui.GuiSelectClassflintlock;

public class flintlock extends Item
	{
	public flintlock(int id)
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
		...
		Minecraft.getMinecraft().displayGuiScreen(new GuiSelectClassflintlock());
