...
public class Reverieshield extends ItemArmor
{
	
	public String textureName;

	public Reverieshield(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Reverieshield";
		setUnlocalizedName("Reverieshield");
