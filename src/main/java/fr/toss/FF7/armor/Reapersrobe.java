...
public class Reapersrobe extends ItemArmor
{
	
	public String textureName;

	public Reapersrobe(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Reapersrobe";
		setUnlocalizedName("Reapersrobe");
