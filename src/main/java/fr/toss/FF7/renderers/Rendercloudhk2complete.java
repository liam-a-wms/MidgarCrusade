...
import fr.toss.FF7Weapons.Archsword;
 
 public class Rendercloudhk2complete implements IItemRenderer
 {
   private IModelCustom ArchswordModel;
   private ResourceLocation ArchswordTexture;
   
   public Rendercloudhk2complete()
   {
/* 23 */     this.ArchswordModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/cloudhk2complete.obj"));
/* 24 */     this.ArchswordTexture = new ResourceLocation("FF7:models/cloudhk2complete.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Archsword) {
/* 41 */         Archsword i = (Archsword)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ArchswordTexture);
/* 50 */           this.ArchswordModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ArchswordTexture);
/* 60 */           this.ArchswordModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ArchswordTexture);
/* 71 */       this.ArchswordModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ArchswordTexture);
/* 79 */       this.ArchswordModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ArchswordTexture);
/* 87 */       this.ArchswordModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
