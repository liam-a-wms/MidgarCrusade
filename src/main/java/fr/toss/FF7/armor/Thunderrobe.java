...
public class Thunderrobe extends ItemArmor
{
	
	public String textureName;

	public Thunderrobe(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Thunderrobe";
		setUnlocalizedName("Thunderrobe");
