...
public class Materiaarmor extends ItemArmor
{
	
	public String textureName;

	public Materiaarmor(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Materiaarmor";
		setUnlocalizedName("Materiaarmor");
