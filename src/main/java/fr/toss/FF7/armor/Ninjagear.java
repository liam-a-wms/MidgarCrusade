...
public class Ninjagear extends ItemArmor
{
	
	public String textureName;

	public Ninjagear(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Ninjagear";
		setUnlocalizedName("Ninjagear");
