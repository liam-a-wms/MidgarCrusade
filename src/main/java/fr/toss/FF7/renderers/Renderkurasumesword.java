...
import fr.toss.FF7Weapons.Beastsword;
 
 public class Renderkurasumesword implements IItemRenderer
 {
   private IModelCustom BeastswordModel;
   private ResourceLocation BeastswordTexture;
   
   public Renderkurasumesword()
   {
/* 23 */     this.BeastswordModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/kurasumesword.obj"));
/* 24 */     this.BeastswordTexture = new ResourceLocation("FF7:models/kurasumesword.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Beastsword) {
/* 41 */         Beastsword i = (Beastsword)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BeastswordTexture);
/* 50 */           this.BeastswordModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BeastswordTexture);
/* 60 */           this.BeastswordModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BeastswordTexture);
/* 71 */       this.BeastswordModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BeastswordTexture);
/* 79 */       this.BeastswordModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BeastswordTexture);
/* 87 */       this.BeastswordModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
