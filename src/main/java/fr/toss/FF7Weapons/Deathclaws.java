...
public class Deathclaws extends FF7weapon
{
	public boolean idle;
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Deathclaws(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Death_claws");
  this.field_150934_a = 43F + p_i45356_1_.getDamageVsEntity();
}
