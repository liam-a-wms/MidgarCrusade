...
public class Magickrobe extends ItemArmor
{
	
	public String textureName;

	public Magickrobe(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Magickrobe";
		setUnlocalizedName("Magickrobe");
