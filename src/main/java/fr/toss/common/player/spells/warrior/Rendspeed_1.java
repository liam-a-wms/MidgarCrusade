package fr.toss.common.player.spells.warrior;
...
public class Rendspeed_1 extends Spell {
	...
	{
		return I18n.format("spell.Soldier.rendspeed");
	}
	...
	public String[] getDescription() 
	{
		...
		str = new String[2];
		str[0] = "Drain enemies speed by 4 (+ " + ChatColor.AQUA + (this.player.strength / 20.0f) + ChatColor.RESET + ") ";
		str[1] = "And take half the speed for yourself";
