...
import fr.toss.FF7Weapons.Chaosrifle;
 
 public class Renderremsdagger implements IItemRenderer
 {
   private IModelCustom ChaosrifleModel;
   private ResourceLocation ChaosrifleTexture;
   
   public Renderremsdagger()
   {
/* 23 */     this.ChaosrifleModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/remsdagger.obj"));
/* 24 */     this.ChaosrifleTexture = new ResourceLocation("FF7:models/remsdagger.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Chaosrifle) {
/* 41 */         Chaosrifle i = (Chaosrifle)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ChaosrifleTexture);
/* 50 */           this.ChaosrifleModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.ChaosrifleTexture);
/* 60 */           this.ChaosrifleModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ChaosrifleTexture);
/* 71 */       this.ChaosrifleModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ChaosrifleTexture);
/* 79 */       this.ChaosrifleModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.ChaosrifleTexture);
/* 87 */       this.ChaosrifleModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
