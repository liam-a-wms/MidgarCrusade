...
import fr.toss.FF7Weapons.Broadsword;
 
 public class Renderpaine implements IItemRenderer
 {
   private IModelCustom BroadswordModel;
   private ResourceLocation BroadswordTexture;
   
   public Renderpaine()
   {
/* 23 */     this.BroadswordModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/paine.obj"));
/* 24 */     this.BroadswordTexture = new ResourceLocation("FF7:models/paine.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Broadsword) {
/* 41 */         Broadsword i = (Broadsword)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BroadswordTexture);
/* 50 */           this.BroadswordModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BroadswordTexture);
/* 60 */           this.BroadswordModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BroadswordTexture);
/* 71 */       this.BroadswordModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BroadswordTexture);
/* 79 */       this.BroadswordModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BroadswordTexture);
/* 87 */       this.BroadswordModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
