...
public class Aegisshield extends ItemArmor
{
	
	public String textureName;

	public Aegisshield(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Aegisshield";
		setUnlocalizedName("Aegisshield");
