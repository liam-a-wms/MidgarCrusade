...
public class Dragonmail extends ItemArmor
{
	
	public String textureName;

	public Dragonmail(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Dragonmail";
		setUnlocalizedName("Dragonmail");
