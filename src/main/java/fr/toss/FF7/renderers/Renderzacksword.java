...
import fr.toss.FF7Weapons.Diabolique;
 
 public class Renderzacksword implements IItemRenderer
 {
   private IModelCustom DiaboliqueModel;
   private ResourceLocation DiaboliqueTexture;
   
   public Renderzacksword()
   {
/* 23 */     this.DiaboliqueModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/zacksword.obj"));
/* 24 */     this.DiaboliqueTexture = new ResourceLocation("FF7:models/zacksword.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Diabolique) {
/* 41 */         Diabolique i = (Diabolique)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.DiaboliqueTexture);
/* 50 */           this.DiaboliqueModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.DiaboliqueTexture);
/* 60 */           this.DiaboliqueModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DiaboliqueTexture);
/* 71 */       this.DiaboliqueModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DiaboliqueTexture);
/* 79 */       this.DiaboliqueModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DiaboliqueTexture);
/* 87 */       this.DiaboliqueModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
