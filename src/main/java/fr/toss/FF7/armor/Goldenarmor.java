...
public class Goldenarmor extends ItemArmor
{
	
	public String textureName;

	public Goldenarmor(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Goldenarmor";
		setUnlocalizedName("Goldenarmor");
