...
import fr.toss.FF7Weapons.Crownscepter;
 
 public class Rendertisword1 implements IItemRenderer
 {
   private IModelCustom CrownscepterModel;
   private ResourceLocation CrownscepterTexture;
   
   public Rendertisword1()
   {
/* 23 */     this.CrownscepterModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/Tisword1.obj"));
/* 24 */     this.CrownscepterTexture = new ResourceLocation("FF7:models/Tisword1.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Crownscepter) {
/* 41 */         Crownscepter i = (Crownscepter)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.CrownscepterTexture);
/* 50 */           this.CrownscepterModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.CrownscepterTexture);
/* 60 */           this.CrownscepterModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CrownscepterTexture);
/* 71 */       this.CrownscepterModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CrownscepterTexture);
/* 79 */       this.CrownscepterModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.CrownscepterTexture);
/* 87 */       this.CrownscepterModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
