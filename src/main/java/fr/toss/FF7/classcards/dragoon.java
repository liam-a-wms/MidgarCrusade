...
import fr.toss.client.gui.GuiSelectClassdefender;
import fr.toss.client.gui.GuiSelectHumeClass;

public class dragoon extends Item
	{
	public dragoon(int id)
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
		...
		Minecraft.getMinecraft().displayGuiScreen(new GuiSelectClassdefender());
