...
public class Molotovcocktail_1 extends Spell {
	...
	{
		return I18n.format("spell.juggler.molotov");
	}
	...
	public String[] getDescription() 
	{
		...
		str = new String[3];
		str[0] = "Throw a Molotov Cocktail setting the";
		str[1] = "enemy on fire causing damage and";
		str[2] = "the berserk status";
