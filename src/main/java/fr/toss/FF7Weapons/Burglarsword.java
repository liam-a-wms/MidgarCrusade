...
public class Burglarsword extends FF7weapon
{
	public boolean idle;
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Burglarsword(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Burglar_sword");
  this.field_150934_a = 30F + p_i45356_1_.getDamageVsEntity();
}
