...
public class Metalknuckles extends FF7weapon
{
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Metalknuckles(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Metal_knuckles");
  this.field_150934_a = 29F + p_i45356_1_.getDamageVsEntity();
}
