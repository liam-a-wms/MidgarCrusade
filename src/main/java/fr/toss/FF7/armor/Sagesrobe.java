...
public class Sagesrobe extends ItemArmor
{
	
	public String textureName;

	public Sagesrobe(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Sagesrobe";
		setUnlocalizedName("Sagesrobe");
