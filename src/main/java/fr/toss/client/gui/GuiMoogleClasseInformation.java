...
public class GuiMoogleClasseInformation extends GuiScreen {
	...
	public GuiMoogleClasseInformation(String classe_name, String p_description[], String p_advices[], int px, int py, int p_color, int classe_id)
	{
		super();
