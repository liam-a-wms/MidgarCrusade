...
import fr.toss.FF7Weapons.Battlemace;
 
 public class Renderjackskatana implements IItemRenderer
 {
   private IModelCustom BattlemaceModel;
   private ResourceLocation BattlemaceTexture;
   
   public Renderjackskatana()
   {
/* 23 */     this.BattlemaceModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/jackskatana.obj"));
/* 24 */     this.BattlemaceTexture = new ResourceLocation("FF7:models/jackskatana.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Battlemace) {
/* 41 */         Battlemace i = (Battlemace)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BattlemaceTexture);
/* 50 */           this.BattlemaceModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BattlemaceTexture);
/* 60 */           this.BattlemaceModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BattlemaceTexture);
/* 71 */       this.BattlemaceModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BattlemaceTexture);
/* 79 */       this.BattlemaceModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BattlemaceTexture);
/* 87 */       this.BattlemaceModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
