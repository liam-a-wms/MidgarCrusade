...
import fr.toss.FF7Weapons.Deathclaws;
 
 public class RenderTisword5 implements IItemRenderer
 {
   private IModelCustom DeathclawsModel;
   private ResourceLocation DeathclawsTexture;
   
   public RenderTisword5()
   {
/* 23 */     this.DeathclawsModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/Tisword5.obj"));
/* 24 */     this.DeathclawsTexture = new ResourceLocation("FF7:models/Tisword5.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Deathclaws) {
/* 41 */         Deathclaws i = (Deathclaws)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.DeathclawsTexture);
/* 50 */           this.DeathclawsModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.DeathclawsTexture);
/* 60 */           this.DeathclawsModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DeathclawsTexture);
/* 71 */       this.DeathclawsModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DeathclawsTexture);
/* 79 */       this.DeathclawsModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DeathclawsTexture);
/* 87 */       this.DeathclawsModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
