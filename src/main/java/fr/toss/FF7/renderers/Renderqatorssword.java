...
import fr.toss.FF7Weapons.Burglarsword;
 
 public class Renderqatorssword implements IItemRenderer
 {
   private IModelCustom BurglarswordModel;
   private ResourceLocation BurglarswordTexture;
   
   public Renderqatorssword()
   {
/* 23 */     this.BurglarswordModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/qatorssword.obj"));
/* 24 */     this.BurglarswordTexture = new ResourceLocation("FF7:models/qatorssword.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Burglarsword) {
/* 41 */         Burglarsword i = (Burglarsword)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BurglarswordTexture);
/* 50 */           this.BurglarswordModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BurglarswordTexture);
/* 60 */           this.BurglarswordModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BurglarswordTexture);
/* 71 */       this.BurglarswordModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BurglarswordTexture);
/* 79 */       this.BurglarswordModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BurglarswordTexture);
/* 87 */       this.BurglarswordModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
