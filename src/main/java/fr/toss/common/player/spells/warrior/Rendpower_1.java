...
public class Rendpower_1 extends Spell {
	...
	{
		return I18n.format("spell.soldier.drainattack");
	}
	...
	public String[] getDescription() 
	{
		...
		str = new String[1];
		str[0] = "Drain enemies Attack by 4 (+ " + ChatColor.AQUA + (this.player.strength / 20.0f) + ChatColor.RESET + ") ";
