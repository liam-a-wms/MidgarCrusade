...
public class GuiMoogleRaceInformation extends GuiScreen {
	...
	public GuiMoogleRaceInformation(String Race_name, String p_description[], String p_advices[], int px, int py, int p_color, int race_id)
	{
		super();
