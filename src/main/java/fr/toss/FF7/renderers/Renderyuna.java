...
import fr.toss.FF7Weapons.Demonbell;
 
 public class Renderyuna implements IItemRenderer
 {
   private IModelCustom DemonbellModel;
   private ResourceLocation DemonbellTexture;
