...
public class Chameleonrobe extends ItemArmor
{
	
	public String textureName;

	public Chameleonrobe(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Chameleonrobe";
		setUnlocalizedName("Chameleonrobe");
