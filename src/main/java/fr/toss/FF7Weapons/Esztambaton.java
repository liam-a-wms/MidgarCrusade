...
public class Esztambaton extends FF7weapon
{
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Esztambaton(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Esztam_baton");
  this.field_150934_a = 42F + p_i45356_1_.getDamageVsEntity();
}
