...
public class Linencuirass extends ItemArmor
{
	
	public String textureName;

	public Linencuirass(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Linencuirass";
		setUnlocalizedName("Linencuirass");
