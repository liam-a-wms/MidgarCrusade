...
public class Judicersstaff extends FF7weapon
{
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Judicersstaff(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Judicers_staff");
  this.field_150934_a = 23F + p_i45356_1_.getDamageVsEntity();
}
