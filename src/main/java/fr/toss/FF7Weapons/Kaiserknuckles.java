...
public class Kaiserknuckles extends FF7weapon
{
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Kaiserknuckles(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Kaiser_knuckles");
  this.field_150934_a = 37F + p_i45356_1_.getDamageVsEntity();
}
