...
import fr.toss.FF7Weapons.Broadaxe;
 
 public class Rendernpcsword2 implements IItemRenderer
 {
   private IModelCustom BroadaxeModel;
   private ResourceLocation BroadaxeTexture;
   
   public Rendernpcsword2()
   {
/* 23 */     this.BroadaxeModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/npcsword2.obj"));
/* 24 */     this.BroadaxeTexture = new ResourceLocation("FF7:models/npcsword2.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Broadaxe) {
/* 41 */         Broadaxe i = (Broadaxe)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BroadaxeTexture);
/* 50 */           this.BroadaxeModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BroadaxeTexture);
/* 60 */           this.BroadaxeModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BroadaxeTexture);
/* 71 */       this.BroadaxeModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BroadaxeTexture);
/* 79 */       this.BroadaxeModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BroadaxeTexture);
/* 87 */       this.BroadaxeModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
