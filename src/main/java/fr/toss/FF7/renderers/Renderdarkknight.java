...
import fr.toss.FF7Weapons.Adazakura;
 
 public class Renderdarkknight implements IItemRenderer
 {
   private IModelCustom DarkKnightModel;
   private ResourceLocation DarkKnightTexture;
   
   public Renderdarkknight()
   {
/* 23 */     this.DarkKnightModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/DarkKnight.obj"));
/* 24 */     this.DarkKnightTexture = new ResourceLocation("FF7:models/DarkKnight.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Adazakura) {
/* 41 */         Adazakura i = (Adazakura)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.DarkKnightTexture);
/* 50 */           this.DarkKnightModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.DarkKnightTexture);
/* 60 */           this.DarkKnightModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DarkKnightTexture);
/* 71 */       this.DarkKnightModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DarkKnightTexture);
/* 79 */       this.DarkKnightModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.DarkKnightTexture);
/* 87 */       this.DarkKnightModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
