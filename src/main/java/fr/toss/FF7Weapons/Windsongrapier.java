...
public class Windsongrapier extends FF7weapon
{
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Windsongrapier(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Wind_song_rapier");
  this.field_150934_a = 56F + p_i45356_1_.getDamageVsEntity();
}
