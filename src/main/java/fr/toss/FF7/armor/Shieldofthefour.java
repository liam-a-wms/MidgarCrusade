...
public class Shieldofthefour extends ItemArmor
{
	
	public String textureName;

	public Shieldofthefour(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Shieldofthefour";
		setUnlocalizedName("Shieldofthefour");
