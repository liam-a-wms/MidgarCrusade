...
import fr.toss.FF7Weapons.Ashura;
 
 public class Rendercloudultima implements IItemRenderer
 {
   private IModelCustom AshuraModel;
   private ResourceLocation AshuraTexture;
   
   public Rendercloudultima()
   {
/* 23 */     this.AshuraModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/cloudultima.obj"));
/* 24 */     this.AshuraTexture = new ResourceLocation("FF7:models/cloudultima.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Ashura) {
/* 41 */         Ashura i = (Ashura)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.AshuraTexture);
/* 50 */           this.AshuraModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.AshuraTexture);
/* 60 */           this.AshuraModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AshuraTexture);
/* 71 */       this.AshuraModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AshuraTexture);
/* 79 */       this.AshuraModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.AshuraTexture);
/* 87 */       this.AshuraModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
