...
public class Judicerscoat extends ItemArmor
{
	
	public String textureName;

	public Judicerscoat(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Judicerscoat";
		setUnlocalizedName("Judicerscoat");
