...
public class Cover_1 extends Spell {
	...
	{
		return I18n.format("spell.paladin.cover");
	}
	...
	public String[] getDescription() 
	{
		...
		str = new String[3];
		str[0] = "Become invincible and gain";
		str[1] = "the ability to Cover for";
		str[2] = "your team for 3 seconds";
