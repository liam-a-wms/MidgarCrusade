...
public class Platinumshield extends ItemArmor
{
	
	public String textureName;

	public Platinumshield(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Platinumshield";
		setUnlocalizedName("Platinumshield");
