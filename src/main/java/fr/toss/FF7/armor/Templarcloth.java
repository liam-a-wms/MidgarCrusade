...
public class Templarcloth extends ItemArmor
{
	
	public String textureName;

	public Templarcloth(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Templarcloth";
		setUnlocalizedName("Templarcloth");
