...
public class Chocoboshield extends ItemArmor
{
	
	public String textureName;

	public Chocoboshield(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Chocoboshield";
		setUnlocalizedName("Chocoboshield");
