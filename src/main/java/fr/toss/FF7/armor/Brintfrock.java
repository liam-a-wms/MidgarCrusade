...
public class Brintfrock extends ItemArmor
{
	
	public String textureName;

	public Brintfrock(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Brintfrock";
		setUnlocalizedName("Brintfrock");
