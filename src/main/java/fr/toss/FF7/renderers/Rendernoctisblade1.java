...
import fr.toss.FF7Weapons.Bombarm;
 
 public class Rendernoctisblade1 implements IItemRenderer
 {
   private IModelCustom BombarmModel;
   private ResourceLocation BombarmTexture;
   
   public Rendernoctisblade1()
   {
/* 23 */     this.BombarmModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/noctisblade1.obj"));
/* 24 */     this.BombarmTexture = new ResourceLocation("FF7:models/noctisblade1.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Bombarm) {
/* 41 */         Bombarm i = (Bombarm)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BombarmTexture);
/* 50 */           this.BombarmModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BombarmTexture);
/* 60 */           this.BombarmModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BombarmTexture);
/* 71 */       this.BombarmModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BombarmTexture);
/* 79 */       this.BombarmModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BombarmTexture);
/* 87 */       this.BombarmModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
