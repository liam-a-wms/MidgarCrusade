...
import fr.toss.FF7Weapons.Adamantblade;
 ...
 public class RenderRedscythe implements IItemRenderer
 {
   private IModelCustom AdamantbladeModel;
   private ResourceLocation AdamantbladeTexture;
   
   public RenderRedscythe()
   {
/* 23 */     this.AdamantbladeModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/Redscythe.obj"));
/* 24 */     this.AdamantbladeTexture = new ResourceLocation("FF7:models/Redscythe.png");
   }
