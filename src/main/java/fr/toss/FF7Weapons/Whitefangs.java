...
public class Whitefangs extends FF7weapon
{
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Whitefangs(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("White_fangs");
  this.field_150934_a = 39F + p_i45356_1_.getDamageVsEntity();
}
