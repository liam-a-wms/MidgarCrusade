...
public class Bronzeshield extends ItemArmor
{
	
	public String textureName;

	public Bronzeshield(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Bronzeshield";
		setUnlocalizedName("Bronzeshield");
