...
public class Saintcross_1 extends Spell {
	...
	{
		return I18n.format("spell.paladin.saintcross");
	}
	...
	public boolean onUse()
	{
		...
		if (list.size() > 0)
		{
			...
			player.getPlayer().addChatComponentMessage(new ChatComponentText(ChatColor.RED + "No enemies around." + ChatColor.RESET));
		return (false);
	}
	...
	public String[] getDescription() 
	{
		...
		str = new String[2];
		str[0] = "Inflict 2 holy damages to";
		str[1] = "every mobs around you";
