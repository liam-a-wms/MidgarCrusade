...
public class GuiSelectVieraClass extends GuiScreen {
	...
	public void initGui()
	{
		...
		buttons[1] = new GuiButton(50, this.width / 2 - 40, this.height / 2 - 44, 80, 20, ChatColor.RESET + I18n.format("classe.Archer"));
		
		buttons[2] = new GuiButton(102, this.width / 2 - 40, this.height / 2 - 66, 80, 20, ChatColor.RESET + I18n.format("classe.Whitemage"));
