...
public class Cypresspole extends FF7weapon
{
	public boolean idle;
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Cypresspole(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Cypress_pole");
  this.field_150934_a = 32F + p_i45356_1_.getDamageVsEntity();
}
