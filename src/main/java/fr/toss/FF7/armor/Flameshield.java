...
public class Flameshield extends ItemArmor
{
	
	public String textureName;

	public Flameshield(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Flameshield";
		setUnlocalizedName("Flameshield");
