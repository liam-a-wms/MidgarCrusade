...
public class Blackgarb extends ItemArmor
{
	
	public String textureName;

	public Blackgarb(ArmorMaterial material, int render_idx, int type) {
		super(material, 0, type);
		this.textureName = "Blackgarb";
		setUnlocalizedName("Blackgarb");
