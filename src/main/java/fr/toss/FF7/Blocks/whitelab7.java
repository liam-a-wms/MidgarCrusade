...
public class whitelab7 extends Block {
	    ...
	    public void onBlockAdded(World p_149726_1_, int p_149726_2_, int p_149726_3_, int p_149726_4_)
	    {
	        if (!p_149726_1_.isRemote)
	        {
	            ...
	            {
	                p_149726_1_.setBlock(p_149726_2_, p_149726_3_, p_149726_4_, BlockRegistry1.whitelab7on, 0, 2);
	            }
	        }
	    }
	    ...
	    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
	    {
	        if (!p_149695_1_.isRemote)
	        {
	            ...
	            {
	                p_149695_1_.setBlock(p_149695_2_, p_149695_3_, p_149695_4_, BlockRegistry1.whitelab7on, 0, 2);
	            }
	        }
	    }
	    ...
	    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
	    {
	        ...
	        {
	            p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, BlockRegistry1.whitelab7, 0, 2);
	        }
	    }

	    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_)
	    {
	        return Item.getItemFromBlock(BlockRegistry1.whitelab7);
	    }
	    ...
	    {
	        return new ItemStack(BlockRegistry1.whitelab7);
	    }
	}