...
import fr.toss.FF7Weapons.Battlerapier;
 
 public class Renderjechtssword implements IItemRenderer
 {
   private IModelCustom BattlerapierModel;
   private ResourceLocation BattlerapierTexture;
   
   public Renderjechtssword()
   {
/* 23 */     this.BattlerapierModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/jechtssword.obj"));
/* 24 */     this.BattlerapierTexture = new ResourceLocation("FF7:models/jechtssword.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Battlerapier) {
/* 41 */         Battlerapier i = (Battlerapier)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BattlerapierTexture);
/* 50 */           this.BattlerapierModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BattlerapierTexture);
/* 60 */           this.BattlerapierModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BattlerapierTexture);
/* 71 */       this.BattlerapierModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BattlerapierTexture);
/* 79 */       this.BattlerapierModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BattlerapierTexture);
/* 87 */       this.BattlerapierModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
