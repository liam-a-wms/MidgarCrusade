...
public class Magemasher extends FF7weapon
{
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Magemasher(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Mage_masher");
  this.field_150934_a = 36F + p_i45356_1_.getDamageVsEntity();
}
