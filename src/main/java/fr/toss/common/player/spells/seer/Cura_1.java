package fr.toss.common.player.spells.seer;
...
public class Cura_1 extends Spell {
	...
	{
		return I18n.format("spell.whitemage.cura");
	}
	...
	public String[] getDescription() 
	{
		...
		str = new String[3];
		str[0] = "A spell that will heal";
		str[1] = "an area around you for 9 hp";
