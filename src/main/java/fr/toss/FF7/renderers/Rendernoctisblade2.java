...
import fr.toss.FF7Weapons.Brevis;
 
 public class Rendernoctisblade2 implements IItemRenderer
 {
   private IModelCustom BrevisModel;
   private ResourceLocation BrevisTexture;
   
   public Rendernoctisblade2()
   {
/* 23 */     this.BrevisModel = AdvancedModelLoader.loadModel(new ResourceLocation("FF7:models/noctisblade2.obj"));
/* 24 */     this.BrevisTexture = new ResourceLocation("FF7:models/noctisblade2.png");
   }
...
/* 40 */       if (item.getItem() == ItemRegistry1.Brevis) {
/* 41 */         Brevis i = (Brevis)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BrevisTexture);
/* 50 */           this.BrevisModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BrevisTexture);
/* 60 */           this.BrevisModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BrevisTexture);
/* 71 */       this.BrevisModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BrevisTexture);
/* 79 */       this.BrevisModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BrevisTexture);
/* 87 */       this.BrevisModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
