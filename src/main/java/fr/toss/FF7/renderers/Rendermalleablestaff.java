...
import fr.toss.FF7Weapons.Blackquena;
 
 public class Rendermalleablestaff implements IItemRenderer
 {
   private IModelCustom BlackquenaModel;
   private ResourceLocation BlackquenaTexture;
...
/* 40 */       if (item.getItem() == ItemRegistry1.Blackquena) {
/* 41 */         Blackquena i = (Blackquena)item.getItem();
/* 42 */         if (i.idle) {
...
/* 49 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BlackquenaTexture);
/* 50 */           this.BlackquenaModel.renderAll();
/* 51 */           GL11.glPopMatrix();
         } else {
...
/* 59 */           Minecraft.getMinecraft().renderEngine.bindTexture(this.BlackquenaTexture);
/* 60 */           this.BlackquenaModel.renderAll();
/* 61 */           GL11.glPopMatrix();
         }
       }
     }
...
/* 70 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BlackquenaTexture);
/* 71 */       this.BlackquenaModel.renderAll();
/* 72 */       GL11.glPopMatrix();
...
/* 78 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BlackquenaTexture);
/* 79 */       this.BlackquenaModel.renderAll();
/* 80 */       GL11.glPopMatrix();
     } else {
...
/* 86 */       Minecraft.getMinecraft().renderEngine.bindTexture(this.BlackquenaTexture);
/* 87 */       this.BlackquenaModel.renderAll();
/* 88 */       GL11.glPopMatrix();
     }
   }
 }
