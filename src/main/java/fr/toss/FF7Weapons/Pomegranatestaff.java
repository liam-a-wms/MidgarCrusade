...
public class Pomegranatestaff extends FF7weapon
{
private float field_150934_a;
private final Item.ToolMaterial field_150933_b;

public Pomegranatestaff(Item.ToolMaterial p_i45356_1_)

{
	
  super();
  this.field_150933_b = p_i45356_1_;
  setUnlocalizedName("Pomegranate_staff");
  this.field_150934_a = 31F + p_i45356_1_.getDamageVsEntity();
}
